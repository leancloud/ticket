...
const ExceptionPage: React.FunctionComponent<{
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center">
      ...
      <div className="text-black text-lg my-2.5 font-bold">{title || 'Error'}</div>
      <div className="text-gray-500">{subtitle || 'Sorry, the server is reporting an error'}</div>
    </div>
  );
};

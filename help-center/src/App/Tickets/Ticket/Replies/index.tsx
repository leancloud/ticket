  ...
  return (
    <div className="flex">
      <div className="shrink-0 flex flex-col">
        <div
          className={cx('shrink-0 flex mt-[5px] w-[12px] h-[12px] rounded-full left-[-6px]', {
      ...
      <div className="grow ml-2 pb-8">
        ...
        <div
          className={cx('inline-block rounded-2xl rounded-tl-none mt-2 p-2', {
        ...
        >
          ...
          {files && files.length > 0 && <FileItems gallery className="ml-2 mt-2" files={files} />}
        </div>
      </div>
    </div>
  );
